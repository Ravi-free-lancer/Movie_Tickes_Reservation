            ...
            <label for="" class="row justify-content-left d-flex" style="color: dodgerblue;"><h1>Movies On Screen</h1></label>
              ...
              <!-- <div class="card "> -->
                  ...
                  <div class="card-body text-center">
                    <button type="button" class="btn btn-primary col-md-3" data-toggle="modal" data-target="#open"><span class="fas fa-book"></span> Book</button>
                  </div>
...
<!--####################################################Get Seat group name##########################################################################-->
                            ...
                            <button type="submit" name="Register" class="btn btn-success ml-4 w-25"><i class="fas fa-book"></i> Book</button>
                            </div>
                            </form>
                     </div>
             </div>
